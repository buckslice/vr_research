...
public class SyncTransformation : SyncScript
{
 ...
 //   [SerializeField]
    ...
    //[Tooltip("If true, sets position and rotation as if local to other transform")]
    ...
    void SetCurTransform()
    {
        ...
        //{
        //    curPos = relativeTransform.InverseTransformPoint(curPos);
        //    curRot = curRot * relativeTransform.rotation;
        //    //curScale = ...
        //}
    }
